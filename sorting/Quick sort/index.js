...
async function lometo_partition(l, r, delay = delaySpeed() * 7) {
  ...
  for (var k = 0; k < 20; k++) blocks[k].style.backgroundColor = "black";
  return i;
}

// Asynchronous QuickSort function
async function QuickSort(l, r, delay = delaySpeed()) {
  if (l < r) {
